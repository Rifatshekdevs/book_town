...
class AboutPageImageSlider extends StatefulWidget {
  const AboutPageImageSlider({Key? key}) : super(key: key);

  @override
  _AboutPageImageSliderState createState() => _AboutPageImageSliderState();
}

class _AboutPageImageSliderState extends State<AboutPageImageSlider> {
  int _currentIndex = 0;
